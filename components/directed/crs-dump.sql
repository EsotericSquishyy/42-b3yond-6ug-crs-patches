...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'sanitizerenum') THEN
        CREATE TYPE sanitizerenum AS ENUM ('address', 'UBSAN', 'MSAN', 'JAZZER', 'UNKNOWN');
    END IF;
...
a804eadc-299e-430f-9812-39f0d85251e9	1	fc28ffec-3e9e-4822-9a0b-a6f9f6615d6d	1740096099	libexif	libexif	full	processing	2025-02-20 20:02:21.693943+00	{}
...
-- Insert test source data (depends on tasks data above)
INSERT INTO public.sources (task_id, sha256, source_type, url, path) VALUES
('a804eadc-299e-430f-9812-39f0d85251e9', '18c27686b3049607470229e211f643bdd14cab669cda75b19a192d445c6bc908', 'repo', '/crs_sarif/tests/libexif/libexif.tar.gz', '/crs_sarif/tests/libexif/libexif.tar.gz'),
('a804eadc-299e-430f-9812-39f0d85251e9', '18c27686b3049607470229e211f643bdd14cab669cda75b19a192d445c6bc908', 'diff', '/crs_sarif/tests/libexif/DIFF.tar.gz', '/crs_sarif/tests/libexif/DIFF.tar.gz'),
('a804eadc-299e-430f-9812-39f0d85251e9', '18c27686b3049607470229e211f643bdd14cab669cda75b19a192d445c6bc908', 'fuzz_tooling', '/crs_sarif/tests/libexif/fuzz-tooling.tar.gz', '/crs_sarif/tests/libexif/fuzz-tooling.tar.gz');
