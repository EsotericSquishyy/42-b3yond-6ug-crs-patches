...
type GetStatusOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.TypesStatus `json:"body,omitempty"`
}
...
func (o *GetStatusOK) WithPayload(payload *models.TypesStatus) *GetStatusOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get status o k response
func (o *GetStatusOK) SetPayload(payload *models.TypesStatus) {
	o.Payload = payload
}
